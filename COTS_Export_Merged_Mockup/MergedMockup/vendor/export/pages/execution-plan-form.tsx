...
export function ExecutionPlanForm() {
  ...
  if (!paymentTerms.trim()) errors["ep-payment-terms"] = "Enter the export contract payment terms.";
        ...
        <form className="stack" onSubmit={submit} noValidate>
          ...
          <div className="fields">
            ...
            <FormRow
              ...
              hint={`The export contract's terms, which are not the sales contract's — ${c.contractNo} carries "${c.paymentTerms}". The captured plans hold a short form such as DA.`}
            >
              <TextInput
                id="ep-payment-terms"
                value={paymentTerms}
