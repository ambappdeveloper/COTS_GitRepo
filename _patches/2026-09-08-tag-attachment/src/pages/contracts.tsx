  ...
  return (
    <>
      ...
      <CollapsibleSection title="Tags specification flow (activity 3)">
        ...
        {/*
          The tag or artwork file the specification is written against — 8 September 2026.

          A file name and not a file, which is what `Artwork design` on the contract form is
          too; the prototype stores names. It is optional, because §6.5 activity 3 describes
          the buyer's tag options in words and names no document, and a required attachment
          would be a rule invented here. See the open note beside `attachmentFileName`.
        */}
        <FormRow
          label="Attachment"
          htmlFor="tg-attachment"
          hint="The tag or artwork file this specification is written against. A file name only — this prototype stores names, not files. Optional: the file may follow the specification."
        >
          <TextInput
            id="tg-attachment"
            value={tagAttachment}
