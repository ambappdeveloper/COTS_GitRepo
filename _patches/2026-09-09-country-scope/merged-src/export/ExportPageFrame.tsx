...
import { CountryScopeLine } from '@export/components/CountryScopeNotice';
import {
  EXPORT_PHASES,
  TOTAL_PHASES,
  fieldNote,
            ...
            */}
            <Box className="cots-export">
              ...
              <Box component="main" id="export-main" tabIndex={-1}>
                {/*
                  Every Export list is filtered to the session's country — which here is the
                  country in the header above. The line says so on every Export screen, for
                  the reason given on `CountryScopeLine`: a sentence added list by list is a
                  sentence the next list is missing.
                */}
                <CountryScopeLine />
                <ExportErrorBoundary>
                  <Outlet />
