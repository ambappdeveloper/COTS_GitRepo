...
import { ExportCountryScope } from './integration/ExportCountryScope';
import App from './App';
                              ...
                              <S11Provider>
                                <JourneyProvider>
                                  ...
                                  <CountrySync>
                                    ...
                                    <MasterDataSync>
                                      {/* v2.9 — the header's country scopes every Export list,
                                          counter and task. At the root rather than inside the
                                          Export frame, because the Actions Inbox reads Export
                                          data from a Core route. */}
                                      <ExportCountryScope>
                                        <App />
                                      </ExportCountryScope>
                                    </MasterDataSync>
