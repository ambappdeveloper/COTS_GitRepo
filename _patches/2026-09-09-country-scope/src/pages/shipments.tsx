 ...
 * branch name)."
 *
 * WHY IT IS HERE AND NOT ON THE CREATE FORM. Finance answers this, and Finance does not raise
 * the split — Dubai Execution does. Putting the fields on the New shipment form would ask the
 * wrong function for them at the moment the record is made. So the split is raised without
 * them, the `shipment_bank_details` milestone leaves a row in the Actions Inbox addressed to
 * Finance, and the row links here.
 *
