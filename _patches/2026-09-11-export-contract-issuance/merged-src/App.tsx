...
import { ExportContractIssuanceForm, ExportContractRequestForm } from '@export/pages/preclearance-form';
            ...
            <Route element={<CoreShell />}>
              ...
              <Route element={<RequireModule module={MODULE_EXPORT} />}>
                ...
                <Route element={<ExportPageFrame />}>
                  ...
                  {/* Before `/pre-clearance/:id`. The issuance the ministry returns — 11 Sep 2026.
                      Declared in BOTH route tables: this application re-declares every Export
                      route rather than mounting Export's router, and a route added to only one
                      is the Procurement defect of 3 September repeating. */}
                  <Route path="/pre-clearance/:id/edit" element={<ExportContractIssuanceForm />} />
