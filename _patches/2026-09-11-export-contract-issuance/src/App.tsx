...
import { CountryScopeSync } from "./auth/CountryScopeSync";
  ...
  return (
    <ThemeProvider>
      <Router>
        <AuthProvider>
          {/*
            9 September 2026 — the session's country scopes every list. Inside the merged
            application the same component is mounted by `ExportPageFrame`, so the rule is
            written once and both hosts read it from here.
          */}
          <CountryScopeSync />
          <ToastProvider>
            <Routes>
